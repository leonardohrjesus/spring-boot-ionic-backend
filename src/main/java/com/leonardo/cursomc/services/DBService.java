...
public class DBService {
	...
	public void intantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "leonardo.hrjesus@gmail.com", "36378912377",
				TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));

		Cliente cli2 = new Cliente(null, "Ana Costa", "leonardo.hrjesus@hotmail.com", "00000014141",
				TipoCliente.PESSOAFISICA, pe.encode("123"));
